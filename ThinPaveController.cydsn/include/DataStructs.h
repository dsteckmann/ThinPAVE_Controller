...
typedef struct constants_s
{
  ...
  double       H275 ;            //8 2
  double       H110;             //8 3
  double       H210;             //8 4 34 * 8 = 272
  uint32_t     SERIAL_NUM;       //4 276
  uint16_t     DENS_1_CAL_STD;   //2 278 saves sys 1 standard count at time of calibration
  uint16_t     DENS_2_CAL_STD;   //2 280 saves sys 2standard count at time of calibration
  date_time_t  CAL_DATE;         //7 287
 } constants_t; // 287 bytes
